...
<html lang="en">
    ...
    <body>
        ...
        <div class="form_container_over container">
            ...
            <div class="form_container container" style="padding: 0;">

                <form action="adminadd" method="post"class="journey_form">
                    ...
                    <div class="update-container">
                        ...
                        <div  class="update-after">
                            ...
                            <div class="update-detail">
                                ...
                                <div style="border-bottom: 0.5px solid green;" class="detail-data ">
                                    <input  class="date_in" required="" type="date" name="date" />
                                </div>
                                <!-- Department time -->
                                <div style="border-bottom: 0.5px solid green;" class="detail">
                                    <p>Departure time</p>
                                ...
                                <div style="border-bottom: 0.5px solid green;" class="detail-data ">
                                    <select name="deptime" required="" size="">
                                        <c:forEach var="d" items="${requestScope.dlist}">
                                            <option>${d.depTime} </option>
                                        </c:forEach>
                                    </select>
                                </div>
                   ...
                   <div class="save-add">
                        <div style="" class="save-add">
                            <a style="text-decoration: none; color: green" href="adminlist?action=journey">
                                Back
                            </a>
                        </div>
