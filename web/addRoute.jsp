<%-- 
    Document   : addRoute
    Created on : Jul 17, 2023, 11:11:02 PM
    Author     : USER
--%>
    ...
    <body>
        ...
        <div class="location-container">
            ...
            <form class="location-edit-container" action="adminadd" method="POST" >
                ...
                <table>
                    <h1 style="background-color: #f2f2f2; width: 100%; ">Add Route</h1>
                    <h3 style="color: red;">${requestScope.routeExist}</h3>
                            ...
                            <div class="form_Search_Routes-container_small">
                                ...
                                <select id="start" name="routeStart" id="" required onchange="updateDestinationOptions()">
                                    ...
                                    <c:forEach items="${requestScope.listlocation}" var="l">
                                        <option  value="${l.locationID}" ${l.locationID == requestScope.start ? "selected":""}>${l.locationCity}</option>
                                    </c:forEach>
                        ...
                        <td>
                            <div class="form_Search_Routes-container_small">
                                ...
                                <select id="dest" name="routeDest" id="" required onchange="updateStartOptions()"  >
                                    ...
                                    <c:forEach items="${requestScope.listlocation}" var="l">
                                        <option value="${l.locationID}" ${l.locationID == requestScope.dest ? "selected":""}>${l.locationCity}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>Time</td>
                        <td>
                            <input type="number" value="${requestScope.routeTime}" name="routeTime" min="1"  placeholder="Edit Time" required/>
                        </td>
                    </tr>
                    <tr>
                        <td>Price</td>
                        <td>
                            <input type="number" value="${requestScope.routePrice}" name="routePrice" min="1" placeholder="Edit Price"  required/>
                        </td>
                    </tr>
                    <tr>
                        <td>Length</td>
                        <td>
                            <input type="number" value="${requestScope.routeLength}" name="routeLength" min="10" placeholder="Edit Length"  required/>
                        </td>
                    </tr>
                </table>
